...
>
	<div
		...
		bind:this={dockItem}
		use:motion
		class="group flex aspect-square items-center justify-center overflow-hidden rounded-full border border-neutral-200 bg-neutral-50 p-2 text-neutral-800 shadow-inner shadow-neutral-800 transition duration-500 hover:text-black active:-translate-y-10 active:duration-1000 active:ease-out dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-400 dark:shadow-neutral-300/20 dark:hover:text-white"
	>
		<slot />
	</div>
</Motion>
